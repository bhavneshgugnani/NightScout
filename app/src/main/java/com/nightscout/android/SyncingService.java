...
import com.nightscout.android.angellist.GlucoseMonitor;
...
public class SyncingService extends IntentService {
    ...
    public int onStartCommand(Intent intent, int flags, int startId) {
        GlucoseMonitor.setContext(getApplicationContext());
        GlucoseMonitor.setLocationManager((LocationManager) getApplicationContext().getSystemService(Context.LOCATION_SERVICE));
    ...
    protected void handleActionSync(int numOfPages, Context context, DeviceTransport serialDriver) {
        ...
        if (serialDriver != null) {
            ...
            try {
                ...
                //register glucose level reading to glucose monitor for angel list functionality
                GlucoseMonitor.registerGlucoseLevel(recentEGV.getBgMgdl());
    ...
    protected void broadcastSGVToUI() {
        ...
        //register default value to glucose monitor for angel list functionality
        GlucoseMonitor.registerGlucoseLevel(-1);
    }
